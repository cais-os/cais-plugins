...
- User wants to find templates for a use case (e.g., "CMS", "storage",
  "monitoring")
...
**Important:** `serializedConfig` is the exact JSON object from the template
query, not a string.
...
For complete variable syntax and wiring patterns, see
...
**Frontend applications** run in the browser and cannot access Railway's private
network. Options:
